...
if ((districtcode == "" || districtcode == null) && manageusername != null && manageusername != "" && manageusername != username) {
    //manageusername = getCookie("page_farmusername_4");
    //username = getCookie("watchdogusername");
    $("#a_adminadd").css("display", "none");
    //$("#a_goback").click(function () {
    //    window.location.href = "/PageManageCommon/ManageToNext?clickname=" + manageusername + "&clicknamelevel=3";
    //});
} else {
    //username = getCookie("watchdogusername");
...
$.ajax({
    ...
    success: function (data) {
        if (data == "failed") {
            ...
            var logintime = "";
            if (data != null) {
                if (data.data3[0].privilegelevel == 4) {
            ...
            $("#div_usersearch").click(function () {
                ...
                if ($.trim(managername) == "") {
                    ...
                    searchcontent.privilegelevel = 4;
...
function areaOnClick(id, privilegelevel) {
    switch (privilegelevel) {
        case 5:
            ...
            //alert(id);
            //setCookie("page_farmusername_5", id, "s6000");
