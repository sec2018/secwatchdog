...
<body>
                    ...
                    <table class="table table-hover text-center" style="margin:20px auto">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td id="villagewsqdognumtotal"></td>
                            </tr>
                            <tr class="success">
                                <td>
                                    驱虫犬只比
    ...
    <script src="../js/pages/pagevillage.js" type="text/javascript"></script>
