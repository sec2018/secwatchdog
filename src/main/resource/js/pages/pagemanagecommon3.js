...
if ((districtcode == "" || districtcode == null) && manageusername != null && manageusername != "" && manageusername != username) {
    //username = getCookie("page_farmusername_3");
    //manageusername = getCookie("watchdogusername");
    $("#a_adminadd").css("display", "none");
    //$("#a_goback").click(function () {
    //    window.location.href = "/PageManageCommon/ManageToNext?clickname=" + manageusername + "&clicknamelevel=2";
    //});
} else {
...
$.ajax({
    ...
    success: function (data) {
        if (data == "failed") {
            ...
            var logintime = "";
            if (data != null) {
                if (data.data3[0].privilegelevel == 3) {
            ...
            $("#div_usersearch").click(function () {
                ...
                if ($.trim(managername) == "") {
                    ...
                    searchcontent.privilegelevel = 3;
...
function areaOnClick(id, privilegelevel) {
    switch (privilegelevel) {
        case 4:
            ...
            //alert(id);
            //setCookie("page_farmusername_4", id, "s6000");
