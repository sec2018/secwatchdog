...
//	}
	...
	public static String getPagation(String targetUrl,int totalNum,int currentPage,int pageSize){
		...
		StringBuffer pageCode=new StringBuffer();
		pageCode.append("<li><a onclick='gopage(this);return false;' href='"+targetUrl+"?page=1'>��ҳ</a></li>");
		if(currentPage==1){
			pageCode.append("<li class='disabled'><a href='#'>��һҳ</a></li>");
		}else{
			pageCode.append("<li><a onclick='gopage(this);return false;' href='"+targetUrl+"?page="+(currentPage-1)+"'>��һҳ</a></li>");
		}
		...
		for(int i=currentPage-2;i<=currentPage+2;i++){
			...
			if(i==currentPage){
				...
				pageCode.append("<li><a onclick='gopage(this);return false;' href='"+targetUrl+"?page="+i+"'>"+i+"</a></li>");
			}
		...
		pageCode.append("<li><a onclick='gopage(this);return false;' href='"+targetUrl+"?page="+totalPage+"'>βҳ</a></li>");
		return pageCode.toString();
	}
}
